...
from src.application.pipeline_runner import DEFAULT_EMBEDDING_MODEL, build_book_config
...
def test_build_book_config_uses_default_embedding_settings(tmp_path: Path) -> None:
    ...
    assert output.chunker_config.embedding_provider == EmbedderProvider.OLLAMA
